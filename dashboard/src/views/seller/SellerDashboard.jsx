      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((item, idx) => (
          <motion.div
            ...
            className="flex items-center gap-4 p-6 bg-gradient-to-br from-indigo-100 to-indigo-200 dark:from-gray-800 dark:to-gray-900 rounded-2xl shadow-md cursor-pointer"
          >
          ...
          <ul className="space-y-4">
            {messages.map((msg) => (
              <motion.li
                ...
                className="border-b border-gray-200 dark:border-gray-700 pb-3 cursor-pointer"
              >
