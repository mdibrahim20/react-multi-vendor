...
const SellerToCustomer = () => {
  ...
  const { customerId } = useParams(); // optional, in case you want to highlight selected customer later
    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-white overflow-hidden">
      ...
      <div
        className={`
          ...
          ${
            isMobile
              ? "absolute top-0 left-0 z-30 transition-transform duration-300 ease-in-out"
              : ""
          }
          ${
      ...
      <div
        className={`
          ...
          ${
            isMobile
              ? "absolute top-0 right-0 z-30 transition-transform duration-300 ease-in-out"
              : ""
          }
          ${
